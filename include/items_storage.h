...
public:
     ...
     * 2. check the length of processing_items_ and if meets the ending token
 ...
 * 3. call launch_inference_optimized_encoder_kernel
 * After this step, we are ready to call self-attention block
 */
